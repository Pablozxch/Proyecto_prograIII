...
CREATE OR REPLACE TRIGGER ts_tbl_productos_tbl_productos_seq01 BEFORE INSERT
ON tbl_productos FOR EACH ROW
BEGIN
  :new.pro_id := tbl_productos_seq01.nextval;
END;
;
CREATE OR REPLACE TRIGGER tsu_tbl_productos_tbl_productos_seq01 AFTER UPDATE OF pro_id
ON tbl_productos FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER ts_tbl_empleados_tbl_empleados_seq01 BEFORE INSERT
ON tbl_empleados FOR EACH ROW
BEGIN
  :new.emp_id := tbl_empleados_seq01.nextval;
END;
;
CREATE OR REPLACE TRIGGER tsu_tbl_empleados_tbl_empleados_seq01 AFTER UPDATE OF emp_id
ON tbl_empleados FOR EACH ROW
BEGIN
